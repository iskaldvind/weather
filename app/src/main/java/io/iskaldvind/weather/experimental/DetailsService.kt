...
import io.iskaldvind.weather.view.*
...
class DetailsService(name: String = "DetailService") : IntentService(name) {
            ...
            try {
                ...
                urlConnection.apply {
                    ...
                    addRequestProperty(REQUEST_API_KEY,
                        "f26afc47-f3f9-49f5-875d-e74956f2a95c"
                    )
                }
                ...
                onErrorRequest(e.toString() ?: "Empty error")
            } finally {
    ...
    private fun onResponse(weatherDTO: WeatherDTO) {
        ...
        if (fact == null) {
            ...
            onSuccessResponse(fact.temp, fact.condition)
        }
    }

    private fun onSuccessResponse(temp: Int?, condition: String?) {
